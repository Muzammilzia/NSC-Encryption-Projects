...
import { Encryption } from "../components/simple-caesar-cipher/encryption";
import { Decryption } from "../components/simple-caesar-cipher/decryption";

export const SimpleCaesarCipher: FC = () => {
